...
//   de uma loja. Toda requisição que chega ao servidor passa
...
//   que alguém fizer um pedido à API da B7Store. Muito útil para depuração!
//
// Fluxo visual:
//   Site / Frontend → [Logger Middleware] → Rota → Resposta
// =============================================================
